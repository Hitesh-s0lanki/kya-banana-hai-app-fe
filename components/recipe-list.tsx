...
const RecipeList = ({
    ...
    return (
        <div className=" h-full w-full flex flex-col gap-2 p-8 bg-gradient-to-r from-green-100 via-blue-200 to-purple-400 inset-0 overflow-auto">
            <div className="flex flex-col gap-5">
                <h1 className=" text-xl font-semibold">Recipe&apos;s</h1>
                <div className=" grid grid-cols-5 gap-5">
                    {dishs.map((dish) => (
                        ...
                        >
                            ...
                            <div className="px-2 flex flex-col gap-2">
                                ...
                                <p className=" text-xs text-muted-foreground">{dish.dish_description?.slice(0, 100)}</p>
                    ...
                    >
                        <div className=" flex flex-col justify-center items-center gap-4">
                            ...
                            <h2 className=" text-xl font-semibold text-muted-foreground">Add New</h2>
                        </div>
                    </div>
                </div>
            </div>
